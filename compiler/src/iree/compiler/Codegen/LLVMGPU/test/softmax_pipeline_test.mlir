...
module attributes {hal.device.targets = [#device_target_cuda]} {
  hal.executable private @max_sub_exp_dispatch_0 {
    hal.executable.variant public @cuda_nvptx_fb, target = #executable_target_cuda_nvptx_fb {
      hal.executable.export public @max_sub_exp_dispatch_0_generic_16x128x128 ordinal(0) layout(#pipeline_layout) {
      ^bb0(%arg0: !hal.device, %arg1: index, %arg2: index, %arg3: index):
        %x, %y, %z = flow.dispatch.workgroup_count_from_dag_root %arg1, %arg2, %arg3
        hal.return %x, %y, %z : index, index, index
      }
      builtin.module {
        func.func @max_sub_exp_dispatch_0_generic_16x128x128() {
          %c0 = arith.constant 0 : index
          %cst = arith.constant -3.40282347E+38 : f32
          %0 = hal.interface.binding.subspan set(0) binding(0) type(storage_buffer) offset(%c0) alignment(64) : !flow.dispatch.tensor<readonly:16x128x128xf32>
          %1 = hal.interface.binding.subspan set(0) binding(1) type(storage_buffer) offset(%c0) alignment(64) : !flow.dispatch.tensor<writeonly:16x128x128xf32>
          %2 = flow.dispatch.tensor.load %0, offsets = [0, 0, 0], sizes = [16, 128, 128], strides = [1, 1, 1] : !flow.dispatch.tensor<readonly:16x128x128xf32> -> tensor<16x128x128xf32>
          %3 = linalg.init_tensor [16, 128, 128] : tensor<16x128x128xf32>
          %4 = linalg.init_tensor [16, 128] : tensor<16x128xf32>
          %5 = linalg.fill ins(%cst : f32) outs(%4 : tensor<16x128xf32>) -> tensor<16x128xf32>
          %6 = linalg.generic {indexing_maps = [#map0, #map1], iterator_types = ["parallel", "parallel", "reduction"]} ins(%2 : tensor<16x128x128xf32>) outs(%5 : tensor<16x128xf32>) {
          ^bb0(%arg0: f32, %arg1: f32):
            %8 = arith.maxf %arg0, %arg1 : f32
            linalg.yield %8 : f32
          } -> tensor<16x128xf32>
          %7 = linalg.generic {indexing_maps = [#map0, #map1, #map0], iterator_types = ["parallel", "parallel", "parallel"]} ins(%2, %6 : tensor<16x128x128xf32>, tensor<16x128xf32>) outs(%3 : tensor<16x128x128xf32>) {
          ^bb0(%arg0: f32, %arg1: f32, %arg2: f32):
            %8 = arith.subf %arg0, %arg1 : f32
            %9 = math.exp %8 : f32
            linalg.yield %9 : f32
          } -> tensor<16x128x128xf32>
          flow.dispatch.tensor.store %7, %1, offsets = [0, 0, 0], sizes = [16, 128, 128], strides = [1, 1, 1] : tensor<16x128x128xf32> -> !flow.dispatch.tensor<writeonly:16x128x128xf32>
          return
        }
      }
    }
...
//             linalg.yield %10 : f32
//           } -> tensor<12x128xf32>
//           %8:2 = linalg.generic {indexing_maps = [#map0, #map1, #map0, #map1], iterator_types = ["parallel", "parallel", "parallel"]} ins(%2, %7 : tensor<12x128x128xf32>, tensor<12x128xf32>) outs(%3, %5 : tensor<12x128x128xf32>, tensor<12x128xf32>) {
