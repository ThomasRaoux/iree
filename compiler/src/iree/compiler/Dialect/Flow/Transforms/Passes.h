...
// Apply patterns to erase unused linalg operands and remove dead code associated.
std::unique_ptr<OperationPass<mlir::ModuleOp>> createEraseUnusedLinalgOperands();
