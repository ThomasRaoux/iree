...
#ifndef IREE_HAL_CUDA_TIMEPOINT_UTIL_H_
#define IREE_HAL_CUDA_TIMEPOINT_UTIL_H_
...
class TimePointFence final : public RefObject<TimePointFence>,
 ...
 public:
  ...
  // Gets the status of this fence object. This might issue an Cuda API call
  // under the hood.
  VkResult GetStatus();
...
#endif  // IREE_HAL_CUDA_TIMEPOINT_UTIL_H_
