...
#ifndef IREE_HAL_CUDA_ENUMLATED_SEMAPHORE_H_
#define IREE_HAL_CUDA_ENUMLATED_SEMAPHORE_H_

#include "iree/hal/api.h"
#include "iree/hal/cuda/command_queue.h"
#include "iree/hal/cuda/handle_util.h"
#include "iree/hal/cuda/timepoint_util.h"
...
// `VkSemaphore`s.
//
// Cuda provides several explicit synchronization primitives: fences,
// (binary/timeline) semaphores, events, pipeline barriers, and render passes.
// See "6. Synchronization and Cache Control" of the Cuda specification
// for the details.
//
...
// or Cuda 1.2. When it's not available, it can be emulated via `VkFence`s
...
//
// The implementation is inspired by the Cuda-ExtensionLayer project:
// https://github.com/KhronosGroup/Cuda-ExtensionLayer. We don't handle all
...
// emulation of the Cuda spec and thus does not substitute
// Cuda-ExtensionLayer.
...
#endif  // IREE_HAL_CUDA_ENUMLATED_SEMAPHORE_H_
