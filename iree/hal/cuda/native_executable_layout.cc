...
} iree_hal_cuda_native_executable_layout_t;

extern const iree_hal_executable_layout_vtable_t
    iree_hal_cuda_native_executable_layout_vtable;

static iree_hal_cuda_native_executable_layout_t*
iree_hal_cuda_native_executable_layout_cast(
    iree_hal_executable_layout_t* base_value) {
  IREE_HAL_ASSERT_TYPE(base_value,
                       &iree_hal_cuda_native_executable_layout_vtable);
  return (iree_hal_cuda_native_executable_layout_t*)base_value;
}

static iree_status_t iree_hal_cuda_create_pipeline_layout(
  ...
  for (iree_host_size_t i = 0; i < set_layout_count; ++i) {
    set_layout_handles[i] =
        iree_hal_cuda_native_descriptor_set_layout_handle(set_layouts[i]);
  }
...
static void iree_hal_cuda_destroy_pipeline_layout(
...
iree_status_t iree_hal_cuda_native_executable_layout_create(
    iree::hal::cuda::VkDeviceHandle* logical_device,
    iree_host_size_t set_layout_count,
    iree_hal_descriptor_set_layout_t** set_layouts,
  ...
  *out_executable_layout = NULL;
  ...
  IREE_RETURN_AND_END_ZONE_IF_ERROR(
      z0, iree_hal_cuda_create_pipeline_layout(logical_device,
                                                 set_layout_count, set_layouts,
                                                 push_constant_count, &handle));

  iree_hal_cuda_native_executable_layout_t* executable_layout = NULL;
  ...
  if (iree_status_is_ok(status)) {
    ...
    *out_executable_layout = (iree_hal_executable_layout_t*)executable_layout;
    ...
    iree_hal_cuda_destroy_pipeline_layout(logical_device, handle);
  }
...
static void iree_hal_cuda_native_executable_layout_destroy(
    iree_hal_executable_layout_t* base_executable_layout) {
  iree_hal_cuda_native_executable_layout_t* executable_layout =
      iree_hal_cuda_native_executable_layout_cast(base_executable_layout);
  iree_allocator_t host_allocator =
      executable_layout->logical_device->host_allocator();
  IREE_TRACE_ZONE_BEGIN(z0);

  iree_hal_cuda_destroy_pipeline_layout(executable_layout->logical_device,
...
VkPipelineLayout iree_hal_cuda_native_executable_layout_handle(
    iree_hal_executable_layout_t* base_executable_layout) {
  iree_hal_cuda_native_executable_layout_t* executable_layout =
      iree_hal_cuda_native_executable_layout_cast(base_executable_layout);
...
iree_host_size_t iree_hal_cuda_native_executable_layout_set_count(
    iree_hal_executable_layout_t* base_executable_layout) {
  iree_hal_cuda_native_executable_layout_t* executable_layout =
      iree_hal_cuda_native_executable_layout_cast(base_executable_layout);
...
iree_hal_descriptor_set_layout_t* iree_hal_cuda_native_executable_layout_set(
    iree_hal_executable_layout_t* base_executable_layout,
...
const iree_hal_executable_layout_vtable_t
    iree_hal_cuda_native_executable_layout_vtable = {
        /*.destroy=*/iree_hal_cuda_native_executable_layout_destroy,
};
