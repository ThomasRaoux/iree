...
} iree_hal_cuda_native_descriptor_set_t;

extern const iree_hal_descriptor_set_vtable_t
    iree_hal_cuda_native_descriptor_set_vtable;

static iree_hal_cuda_native_descriptor_set_t*
iree_hal_cuda_native_descriptor_set_cast(
    iree_hal_descriptor_set_t* base_value) {
  IREE_HAL_ASSERT_TYPE(base_value,
                       &iree_hal_cuda_native_descriptor_set_vtable);
  return (iree_hal_cuda_native_descriptor_set_t*)base_value;
}

iree_status_t iree_hal_cuda_native_descriptor_set_create(
    iree::hal::cuda::VkDeviceHandle* logical_device, VkDescriptorSet handle,
  ...
  *out_descriptor_set = NULL;
  ...
  iree_hal_cuda_native_descriptor_set_t* descriptor_set = NULL;
  iree_status_t status =
      iree_allocator_malloc(logical_device->host_allocator(),
                            sizeof(*descriptor_set), (void**)&descriptor_set);
  if (iree_status_is_ok(status)) {
    iree_hal_resource_initialize(&iree_hal_cuda_native_descriptor_set_vtable,
...
static void iree_hal_cuda_native_descriptor_set_destroy(
    iree_hal_descriptor_set_t* base_descriptor_set) {
  iree_hal_cuda_native_descriptor_set_t* descriptor_set =
      iree_hal_cuda_native_descriptor_set_cast(base_descriptor_set);
...
VkDescriptorSet iree_hal_cuda_native_descriptor_set_handle(
    iree_hal_descriptor_set_t* base_descriptor_set) {
  iree_hal_cuda_native_descriptor_set_t* descriptor_set =
      iree_hal_cuda_native_descriptor_set_cast(base_descriptor_set);
...
const iree_hal_descriptor_set_vtable_t
    iree_hal_cuda_native_descriptor_set_vtable = {
        /*.destroy=*/iree_hal_cuda_native_descriptor_set_destroy,
};
