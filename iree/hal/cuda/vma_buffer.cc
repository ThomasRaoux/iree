...
typedef struct iree_hal_cuda_vma_buffer_s {
...
} iree_hal_cuda_vma_buffer_t;

extern const iree_hal_buffer_vtable_t iree_hal_cuda_vma_buffer_vtable;

static iree_hal_cuda_vma_buffer_t* iree_hal_cuda_vma_buffer_cast(
    iree_hal_buffer_t* base_value) {
  IREE_HAL_ASSERT_TYPE(base_value, &iree_hal_cuda_vma_buffer_vtable);
  return (iree_hal_cuda_vma_buffer_t*)base_value;
}

iree_status_t iree_hal_cuda_vma_buffer_wrap(
...
static void iree_hal_cuda_vma_buffer_destroy(iree_hal_buffer_t* base_buffer) {
  iree_hal_cuda_vma_buffer_t* buffer =
      iree_hal_cuda_vma_buffer_cast(base_buffer);
...
VkBuffer iree_hal_cuda_vma_buffer_handle(iree_hal_buffer_t* base_buffer) {
  iree_hal_cuda_vma_buffer_t* buffer =
      iree_hal_cuda_vma_buffer_cast(base_buffer);
  return buffer->handle;
}

static iree_status_t iree_hal_cuda_vma_buffer_map_range(
...
static void iree_hal_cuda_vma_buffer_unmap_range(
...
static iree_status_t iree_hal_cuda_vma_buffer_invalidate_range(
    iree_hal_buffer_t* base_buffer, iree_device_size_t local_byte_offset,
...
static iree_status_t iree_hal_cuda_vma_buffer_flush_range(
    iree_hal_buffer_t* base_buffer, iree_device_size_t local_byte_offset,
    iree_device_size_t local_byte_length) {
  iree_hal_cuda_vma_buffer_t* buffer =
      iree_hal_cuda_vma_buffer_cast(base_buffer);
...
const iree_hal_buffer_vtable_t iree_hal_cuda_vma_buffer_vtable = {
    /*.destroy=*/iree_hal_cuda_vma_buffer_destroy,
    /*.map_range=*/iree_hal_cuda_vma_buffer_map_range,
    /*.unmap_range=*/iree_hal_cuda_vma_buffer_unmap_range,
    /*.invalidate_range=*/iree_hal_cuda_vma_buffer_invalidate_range,
    /*.flush_range=*/iree_hal_cuda_vma_buffer_flush_range,
};
