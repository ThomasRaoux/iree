...
#ifndef IREE_HAL_CUDA_VMA_ALLOCATOR_H_
#define IREE_HAL_CUDA_VMA_ALLOCATOR_H_

#include "iree/hal/api.h"
#include "iree/hal/cuda/handle_util.h"
#include "iree/hal/cuda/internal_vk_mem_alloc.h"
...
//
// This uses the Cuda Memory Allocator (VMA) to manage memory.
// VMA (//third_party/cuda_memory_allocator) provides dlmalloc-like behavior
// with suballocations made with various policies (best fit, first fit, etc).
// This reduces the number of allocations we need from the Cuda implementation
...
//
// More information:
//   https://github.com/GPUOpen-LibrariesAndSDKs/CudaMemoryAllocator
//   https://gpuopen-librariesandsdks.github.io/CudaMemoryAllocator/html/
...
#endif  // IREE_HAL_CUDA_VMA_ALLOCATOR_H_
