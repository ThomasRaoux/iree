...
static iree_status_t iree_hal_cuda_driver_factory_enumerate(
  ...
  static const iree_hal_driver_info_t driver_infos[1] = {{
      ...
      /*full_name=*/iree_make_cstring_view("Cuda (dynamic)"),
  }};
...
static iree_status_t iree_hal_cuda_driver_factory_try_create(
  ...
  return iree_hal_cuda_driver_create(identifier, &driver_options, allocator,
                                     out_driver);
}
...
iree_hal_cuda_driver_module_register(iree_hal_driver_registry_t* registry) {
  static const iree_hal_driver_factory_t factory = {
      /*self=*/NULL,
      iree_hal_cuda_driver_factory_enumerate,
      iree_hal_cuda_driver_factory_try_create,
  };
