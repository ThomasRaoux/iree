...
#ifndef IREE_HAL_CUDA_VMA_BUFFER_H_
#define IREE_HAL_CUDA_VMA_BUFFER_H_
...
// Returns the Cuda handle backing the given |buffer|.
// This is the entire allocated_buffer and must be offset by the buffer
// byte_offset and byte_length when used.
VkBuffer iree_hal_cuda_vma_buffer_handle(iree_hal_buffer_t* buffer);

#ifdef __cplusplus
}  // extern "C"
#endif  // __cplusplus

#endif  // IREE_HAL_CUDA_VMA_BUFFER_H_
