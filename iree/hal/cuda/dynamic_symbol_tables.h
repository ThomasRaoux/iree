...
// Use these tables whenever enumerating all functions in the Cuda API is
// required. In most cases IREE_CUDA_DYNAMIC_SYMBOL_TABLES is the right
...
#ifndef IREE_HAL_CUDA_DYNAMIC_SYMBOL_TABLES_H_
#define IREE_HAL_CUDA_DYNAMIC_SYMBOL_TABLES_H_
...
// before Cuda instance creation.
#define IREE_CUDA_DYNAMIC_SYMBOL_INSTANCELESS_TABLE(INS_PFN) \
...
// vkGetInstanceProcAddr/vkGetDeviceProcAddr after Cuda instance/device
// creation.
#define IREE_CUDA_DYNAMIC_SYMBOL_COMMON_TABLE(INS_PFN, DEV_PFN)       \
...
#define IREE_CUDA_DYNAMIC_SYMBOL_TABLE_ANDROID_KHR(INS_PFN, DEV_PFN) \
...
#define IREE_CUDA_DYNAMIC_SYMBOL_TABLE_GGP(INS_PFN, DEV_PFN) \
...
#define IREE_CUDA_DYNAMIC_SYMBOL_TABLE_IOS_MVK(INS_PFN, DEV_PFN) \
...
#define IREE_CUDA_DYNAMIC_SYMBOL_TABLE_FUSCHIA(INS_PFN, DEV_PFN) \
...
#define IREE_CUDA_DYNAMIC_SYMBOL_TABLE_MACOS_MVK(INS_PFN, DEV_PFN) \
...
#define IREE_CUDA_DYNAMIC_SYMBOL_TABLE_METAL_EXT(INS_PFN, DEV_PFN) \
...
#define IREE_CUDA_DYNAMIC_SYMBOL_TABLE_VI_NN(INS_PFN, DEV_PFN) \
...
#define IREE_CUDA_DYNAMIC_SYMBOL_TABLE_WAYLAND_KHR(INS_PFN, DEV_PFN) \
...
#define IREE_CUDA_DYNAMIC_SYMBOL_TABLE_WIN32_KHR(INS_PFN, DEV_PFN) \
...
#define IREE_CUDA_DYNAMIC_SYMBOL_TABLE_XCB_KHR(INS_PFN, DEV_PFN) \
...
#define IREE_CUDA_DYNAMIC_SYMBOL_TABLE_XLIB_KHR(INS_PFN, DEV_PFN) \
...
#define IREE_CUDA_DYNAMIC_SYMBOL_TABLE_XLIB_XRANDR_EXT(INS_PFN, DEV_PFN) \
...
#define IREE_CUDA_DYNAMIC_SYMBOL_PLATFORM_TABLES(INS_PFN, DEV_PFN) \
  IREE_CUDA_DYNAMIC_SYMBOL_TABLE_ANDROID_KHR(INS_PFN, DEV_PFN)     \
  IREE_CUDA_DYNAMIC_SYMBOL_TABLE_GGP(INS_PFN, DEV_PFN)             \
  IREE_CUDA_DYNAMIC_SYMBOL_TABLE_IOS_MVK(INS_PFN, DEV_PFN)         \
  IREE_CUDA_DYNAMIC_SYMBOL_TABLE_FUSCHIA(INS_PFN, DEV_PFN)         \
  IREE_CUDA_DYNAMIC_SYMBOL_TABLE_MACOS_MVK(INS_PFN, DEV_PFN)       \
  IREE_CUDA_DYNAMIC_SYMBOL_TABLE_METAL_EXT(INS_PFN, DEV_PFN)       \
  IREE_CUDA_DYNAMIC_SYMBOL_TABLE_VI_NN(INS_PFN, DEV_PFN)           \
  IREE_CUDA_DYNAMIC_SYMBOL_TABLE_WAYLAND_KHR(INS_PFN, DEV_PFN)     \
  IREE_CUDA_DYNAMIC_SYMBOL_TABLE_WIN32_KHR(INS_PFN, DEV_PFN)       \
  IREE_CUDA_DYNAMIC_SYMBOL_TABLE_XCB_KHR(INS_PFN, DEV_PFN)         \
  IREE_CUDA_DYNAMIC_SYMBOL_TABLE_XLIB_KHR(INS_PFN, DEV_PFN)        \
  IREE_CUDA_DYNAMIC_SYMBOL_TABLE_XLIB_XRANDR_EXT(INS_PFN, DEV_PFN)

#define IREE_CUDA_DYNAMIC_SYMBOL_INSTANCE_DEVICE_TABLES(INS_PFN, DEV_PFN) \
  IREE_CUDA_DYNAMIC_SYMBOL_COMMON_TABLE(INS_PFN, DEV_PFN)                 \
  IREE_CUDA_DYNAMIC_SYMBOL_PLATFORM_TABLES(INS_PFN, DEV_PFN)

#define IREE_CUDA_DYNAMIC_SYMBOL_TABLES(INS_PFN, DEV_PFN) \
  IREE_CUDA_DYNAMIC_SYMBOL_INSTANCELESS_TABLE(INS_PFN)    \
  IREE_CUDA_DYNAMIC_SYMBOL_COMMON_TABLE(INS_PFN, DEV_PFN) \
  IREE_CUDA_DYNAMIC_SYMBOL_PLATFORM_TABLES(INS_PFN, DEV_PFN)
...
#endif  // IREE_HAL_CUDA_DYNAMIC_SYMBOL_TABLES_H_
