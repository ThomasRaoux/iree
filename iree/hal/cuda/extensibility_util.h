...
#ifndef IREE_HAL_CUDA_EXTENSIBILITY_UTIL_H_
#define IREE_HAL_CUDA_EXTENSIBILITY_UTIL_H_

#include "iree/base/arena.h"
#include "iree/hal/cuda/api.h"
#include "iree/hal/cuda/dynamic_symbols.h"

// A list of NUL-terminated strings (so they can be passed directly to Cuda).
typedef struct {
...
typedef struct {
  ...
  // https://www.khronos.org/registry/cuda/specs/1.1-extensions/html/chap44.html#VK_EXT_debug_utils
  bool debug_utils : 1;
...
iree_hal_cuda_populate_enabled_instance_extensions(
    const iree_hal_cuda_string_list_t* enabled_extension);
...
#endif  // IREE_HAL_CUDA_EXTENSIBILITY_UTIL_H_
