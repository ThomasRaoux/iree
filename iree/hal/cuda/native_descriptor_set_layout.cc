...
} iree_hal_cuda_native_descriptor_set_layout_t;

extern const iree_hal_descriptor_set_layout_vtable_t
    iree_hal_cuda_native_descriptor_set_layout_vtable;

static iree_hal_cuda_native_descriptor_set_layout_t*
iree_hal_cuda_native_descriptor_set_layout_cast(
    iree_hal_descriptor_set_layout_t* base_value) {
  IREE_HAL_ASSERT_TYPE(base_value,
                       &iree_hal_cuda_native_descriptor_set_layout_vtable);
  return (iree_hal_cuda_native_descriptor_set_layout_t*)base_value;
}

static iree_status_t iree_hal_cuda_create_descriptor_set_layout(
    VkDeviceHandle* logical_device,
...
static void iree_hal_cuda_destroy_descriptor_set_layout(
...
iree_status_t iree_hal_cuda_native_descriptor_set_layout_create(
    VkDeviceHandle* logical_device,
    iree_hal_descriptor_set_layout_usage_type_t usage_type,
    iree_host_size_t binding_count,
    const iree_hal_descriptor_set_layout_binding_t* bindings,
  ...
  *out_descriptor_set_layout = NULL;
  ...
  IREE_RETURN_AND_END_ZONE_IF_ERROR(
      z0, iree_hal_cuda_create_descriptor_set_layout(
              logical_device, usage_type, binding_count, bindings, &handle));

  iree_hal_cuda_native_descriptor_set_layout_t* descriptor_set_layout = NULL;
  ...
  if (iree_status_is_ok(status)) {
    ...
    *out_descriptor_set_layout =
    ...
    iree_hal_cuda_destroy_descriptor_set_layout(logical_device, handle);
  }
...
static void iree_hal_cuda_native_descriptor_set_layout_destroy(
    iree_hal_descriptor_set_layout_t* base_descriptor_set_layout) {
  iree_hal_cuda_native_descriptor_set_layout_t* descriptor_set_layout =
      iree_hal_cuda_native_descriptor_set_layout_cast(
  ...
  iree_hal_cuda_destroy_descriptor_set_layout(
...
VkDescriptorSetLayout iree_hal_cuda_native_descriptor_set_layout_handle(
    iree_hal_descriptor_set_layout_t* base_descriptor_set_layout) {
  iree_hal_cuda_native_descriptor_set_layout_t* descriptor_set_layout =
      iree_hal_cuda_native_descriptor_set_layout_cast(
          base_descriptor_set_layout);
...
const iree_hal_descriptor_set_layout_vtable_t
    iree_hal_cuda_native_descriptor_set_layout_vtable = {
        /*.destroy=*/iree_hal_cuda_native_descriptor_set_layout_destroy,
};
