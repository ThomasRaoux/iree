...
func.func @conv2d_1x230x230x3_7x7x3x64() -> tensor<1x112x112x64xf32> {
  ...
  %1 = util.unfoldable_constant dense<0.0> : tensor<1x112x112x64xf32>
  %cst_0 = arith.constant 0.000000e+00 : f32
  // TODO: reactivate fill once fusion is fixed.
  ...
  %2 = linalg.conv_2d_nhwc_hwcf {dilations = dense<1> : tensor<2xi64>, strides = dense<2> : tensor<2xi64>} 
       ins(%arg0, %arg1 : tensor<1x230x230x3xf32>, tensor<7x7x3x64xf32>) 
      outs(%1 : tensor<1x112x112x64xf32>)
